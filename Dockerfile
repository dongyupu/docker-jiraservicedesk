...
ENV DOWNLOAD_URL https://product-downloads.atlassian.com/software/jira/downloads/atlassian-servicedesk-4.5.1.tar.gz 
EXPOSE 8080
WORKDIR $JIRA_HOME
#install Opnejdk-1.8.0 and jira-software 8.5.0
RUN set -x \
    && yum -y update \
